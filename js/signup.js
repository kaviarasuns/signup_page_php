$(document).ready(function () {
  ...
  $("#email").focusout(function () {
    ...
    if (email_store.length == "") {
      ...
      $.ajax({
        ...
        dataType: "JSON",
        beforeSend: function () {
          $(".email-error").html('<p class="loading">Loading...</p>');
        },
  ...
  $("#password").focusout(function () {
    ...
    if (password_store.length == "") {
      ...
      $(".password-error").html(
        "<div class='text-success'><i class='fa fa-check-circle'></i> Your Password Is Strong!</div>"
      );
  ...
  $("#submit").click(function () {
    ...
    if (
      ...
      $.ajax({
        type: "POST",
        url: "php/signup.php?signup=true",
...
// fontawesome loading spinner not working, need to check
